...
beautiful.init("/usr/share/awesome/themes/01101010o/theme.lua")
...
myawesomemenu = {
	...
	{ ".Xinitrc", "geany -m /home/olcay/.xinitrc"},
	{ "Gufw Firewall", "gufw"},
...
menumultimedia = {
	...
	{"HandBreak", "ghb"},
	{"Smplayer", "smplayer"},
	{"Espeak", terminal .. " -e espeak -ves+m3 -s154 -p25"}
}
menugame = {
	{"UltraStardx", "ultrastardx"},
	{"SuperTuxKart", "supertuxkart"}
}
menudevelopment = {
	{"Geany", "geany"},
	{"VirtualBox", "virtualbox"},
	{"GNU Octave", terminal .. " -e octave"},
	{"Gnuplot", terminal .. " -e gnuplot"}
}
menuaccessories = {
	{"Settings", myawesomemenu},
	{"Limpieza", terminal .. " -e limpieza"},
	{"Vim", terminal .. " -e vim"},
	{"Python", terminal .. " -e python"}
}
menusystem = {
	{"Htop", terminal .. " -e htop"},
	{"Gparted", terminal.. " -e sudo gparted"},
	{"Arandr","arandr"},
	{"Urxvt","urxvt"},
	{"Xterm", "xterm"},
	{"Uxterm","uxterm"}
...
menulogout = {
	{"Shutdown", terminal .. " -e apagar"},
	{"Reset", terminal .. " -e reiniciar"},
	{"quit", awesome.quit}
}
mymainmenu = awful.menu({ 
					items = {
							{ "Olcay", terminal .. " -e ranger", beautiful.awesome_icon },
							{ "Raspberry Pi", terminal .. " -e ssh -X pi@192.168.1.38"},
							{ "Accessories", menuaccessories },	
							{ "Network", menunetwork },
							{ "Office", menuOffice },
							{ "Graphics", menugraphics },
							{ "Multimedia", menumultimedia },
							{ "Game", menugame },
							{ "Development", menudevelopment},
							{ "System", menusystem },
							{ "Logout ...", menulogout }
							}
                        })
...
--creados por mi
    ...
    awful.key({ }, "Print", function () awful.util.spawn("import -window root screan.png", false) end),
    awful.key({ }, "XF86HomePage", function () awful.util.spawn("uzbl-browser", false) end),
	-- fin teclas multimedia
--hasta aca
    awful.key({ modkey,           }, "j",
        function ()
            awful.client.focus.byidx( 1)
...
awful.rules.rules = {
    ...
    { rule = { name = "Uzbl" }, properties = { tag = tags[1][2] } },
}
-- }}}
